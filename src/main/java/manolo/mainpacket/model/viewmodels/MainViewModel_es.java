...
public class MainViewModel_es implements MainViewModel {
    ...
    private final String FILE_RENAME_ERROR = "Error al renombrar: ";
    ...
    private final String FILE_RENAME_SUCCESS = "Renombrado exitosamente.";
    ...
    private final String NO_FILE_CHOSEN_TO_RENAME = "Nada seleccionado para renombrar.";
